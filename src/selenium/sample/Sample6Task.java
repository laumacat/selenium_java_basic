...
//        1-2 ways to find text: "Test Text 1"
        ...
        assertEquals(testText1, driver.findElement(By.xpath("//div[@id='test1']/p[1]")).getText());

//        1-2 ways to find text: "Test Text 2"
        String testText2 = "Test Text 2";
        assertEquals(testText2, driver.findElement(By.xpath("//div[@id='test1']/p[2]")).getText());


//        1-2 ways to find text: "Test Text 3"
        String testText3 = "Test Text 3";
        assertEquals(testText3, driver.findElement(By.xpath("//div[@id='test3']/p[1]")).getText());

//        1-2 ways to find text: "Test Text 4"
        String testText4 = "Test Text 4";
        assertEquals(testText4, driver.findElement(By.xpath("//div[@id='test3']/p[2]")).getText());

//        1-2 ways to find text: "Test Text 5"
        String testText5 = "Test Text 5";
        assertEquals(testText5, driver.findElement(By.xpath("//div[@id='test2']/p[1]")).getText());
...
//        1-2 ways to find text: "Test Text 3"
        ...
        // in this case next line would work, because it is the first element in with test3 id and test class,
        // but should better do as above, in case there are more elements with same class
        assertEquals(testText3, driver.findElement(By.cssSelector("#test3 > .test")).getText());
...
//        1-2 ways to find text: "This is also a button"
        ...
        assertEquals(button2, driver.findElement(By.cssSelector("input[name='randomButton2']")).getAttribute("value"));
        assertEquals(button2, driver.findElement(By.cssSelector("[type=button][name=randomButton2]")).getAttribute("value"));
